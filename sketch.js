...
function setup() {
	...
	log2Sprite = createSprite(width/2-100,610,20,100 )
	log2Sprite.shapeColor=color("red")
	
	log3Sprite = createSprite(width/2+100,610,20,100 )
	...
	log1Body = Bodies.rectangle(width/2,650,200,20, {isStatic:true})
	World.add(world, log1Body)
	
	log2Body = Bodies.rectangle(width/2-100,610,20,100, {isStatic:true})
	World.add(world, log2Body)

	log3Body = Bodies.rectangle(width/2+100,610,20,100, {isStatic:true})
